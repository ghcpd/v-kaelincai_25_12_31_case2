...
class EventService:
    ...
    def register_participant(
        ...
        # BUG: This will fail for non-ISO formats from Safari/Firefox
        try:
            parsed_datetime = self.date_parser.parse_event_datetime(event_datetime)
        except DateParseError as e:
            # BUG: When Safari/Firefox users submit alternative date formats,
            # parsing fails and registration is rejected
